...
_extend(KMenu, KWidget, {
	...
	addItem : function(item) {
		...
		var itemDiv = K('<div class="ke-menu-Goods" unselectable="on"></div>'),
			leftDiv = K('<div class="ke-inline-block ke-menu-Goods-left"></div>'),
			rightDiv = K('<div class="ke-inline-block ke-menu-Goods-right"></div>'),
		...
		if (self.centerLineMode) {
			centerDiv = K('<div class="ke-inline-block ke-menu-Goods-center"></div>');
			if (height) {
				centerDiv.css('height', height);
			}
		}
		itemDiv.mouseover(function(e) {
			K(this).addClass('ke-menu-Goods-on');
			if (centerDiv) {
				centerDiv.addClass('ke-menu-Goods-center-on');
			}
		})
		.mouseout(function(e) {
			K(this).removeClass('ke-menu-Goods-on');
			if (centerDiv) {
				centerDiv.removeClass('ke-menu-Goods-center-on');
			}
		})
		.click(function(e) {
	...
	remove : function() {
		...
		K('.ke-menu-Goods', self.div[0]).unbind();
