...
$(this).css({"background":"url(/shop/public/images/admin/pancl/flashbutton.gif)",'color':'#fff'}).siblings().css({"background":"url(/shop/public/images/admin/pancl/flashbutton.gif) no-repeat scroll -15px 0 transparent",'color':'#000'}); 
}); 
