...
<div id="content">
    ...
    <div class="order_address_list">
        ...
        <script type="text/javascript" src="/shop/Public/weixin/js/mlselection.js" charset="utf-8"></script>
         <!-- <script type="text/javascript" src="/shop/Public/weixin/js/area.js" charset="utf-8"></script>-->
        <script type="text/javascript" src="/shop/Public/weixin/js/jquery_003.js" charset="utf-8"></script>
        <script type="text/javascript" src="/shop/Public/weixin/js/dialog.js" id="dialog_js" charset="utf-8"></script>
        <link href="/shop/Public/weixin/css/dialog.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/shop/Public/weixin/js/jquery.js" id="dialog_js" charset="utf-8"></script>
...
<script type="text/javascript" language="javascript" src='/shop/Public/weixin/js/diqu2.js'></script>
       ...
       <form method="POST"  action="<?php echo U('Order/pay');?>" id="order_form" name="order_form"   >
        ...
        <?php if(is_array($address_list)): $i = 0; $__LIST__ = $address_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="receive_add address_item selected_address">
            ...
            <li class="name">收货人姓名: <?php echo ($vo["name"]); ?></li>
    ...
    <div class="make_sure">
        ...
        <div>
            <a onclick="ordertj();" class="btn enter">提交订单</a>
