...
<div id="content">
            ...
            <span class="ico1">
                <span class="ico2">
                    <form action="<?php echo U('Goods/search');?>" method="get">
                        <input type="text" name="goods_name" value="<?php echo ($goods_name); ?>" placeholder="输入关键词搜索" /><input type="submit" value="搜索" />
                    </form>
                </span>
            </span>
        </h2>
    ...
    <div class="module_special tbr">
        <h2 class="common_title veins2">
            ...
            <div class="ornament2"></div>
            <span class="ico1">
                <span class="ico2"><?php echo ($cat_name); echo ($goods_name); ?></span>
            </span>
        </h2>
        <div class="wrap">
            <div class="wrap_child">
                <div class="major">
                    <ul class="list">
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li>
                                <div class="pic">
                                    <a href="<?php echo U('Goods/index',array('id'=>$item['id']));?>"><img  src="<?php echo showImage($item['img']);?>"></a>
                                </div>
