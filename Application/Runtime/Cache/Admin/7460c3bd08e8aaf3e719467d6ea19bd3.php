    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><b><?php echo ($val["cat_name"]); ?></b></td>
                <td align="center" class="red"><?php echo ($val["price"]); ?></td>

                <td align="center"><img data-tdtype="toggle" data-id="<?php echo ($val["id"]); ?>" data-field="is_new" data-value="<?php echo ($val["is_hot"]); ?>" src="/shop/Public/images/admin/toggle_<?php if($val["is_hot"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" /></td>
                <td align="center"><img data-tdtype="toggle" data-id="<?php echo ($val["id"]); ?>" data-field="is_new" data-value="<?php echo ($val["is_on_sale"]); ?>" src="/shop/Public/images/admin/toggle_<?php if($val["is_new"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" /></td>
                ...
                <td align="center"><a href="<?php echo u('Goods/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>">修改</a> |
                    <a onclick="return confirm('确定要放入回收站吗？')" href="<?php echo U('Goods/recycle',array('id'=>$val['id'],'p'=>I('get.p',1)));?>">放入回收站</a></td>
