	...
	<table width="100%" class="table_form">
	    ...
	    <tr>
			...
			<td>
				...
				<?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo avatar($info['id'], 32);?>"><img src="/shop/statics/images/filetype/image_s.gif" /></span><?php endif; ?>
            </td>
		</tr>
        <tr>
			<th>会员邮箱 :</th>
