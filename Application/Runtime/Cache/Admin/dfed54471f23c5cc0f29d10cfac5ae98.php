...
<div class="dialog_content">
	<form id="info_form" action="<?php echo U('Category/edit');?>" method="post">
		<table width="100%" class="table_form">
			...
			<tr align="center">
				<td>分类名称
					<input type="text" name="cat_name" id="J_name" class="input-text" size="30" value="<?php echo ($data["cat_name"]); ?>">
				</td>
			</tr>
			<tr>
