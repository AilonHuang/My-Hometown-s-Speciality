...
<style>
    ...
    .tblist thead tr th, .tblist tbody tr.tblist_th td {
        background: url("/shop/Public/weixin/images/tblistthbg.gif") repeat-x scroll 0 0 transparent;
    ...
    <div class="pad_lr_10">
        <div class="col_tab">
                ...
                <div class="content_list pad_10">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbdetail">
                        <tbody>
                            <tr>
                                ...
                                <td width="22%"><?php echo ($info["order_id"]); ?></td>
                        ...
                        <tr>
                            ...
                            <td class="red"><span id="labOrderTotal">¥<?php echo ($info["total_price"]); ?></span></td>
                        </tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbdetail">
                        <tbody>
                            <tr>
                                ...
                                <td width="22%">
                                    <?php switch($info["pay_method"]): case "1": ?>支付宝支付<?php break;?>
                        <?php case "2": ?>货到付款<?php break;?>
                        <?php default: ?>-<?php endswitch;?>
                        </td>
                        <td width="12%" class="tdtitle">是否货到付款:</td>
                        <td width="22%"> <?php switch($info["post_method"]): case "1": ?>否<?php break;?>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbdetail">
                        ...
                        <td width="22%" class="red"><span id="labDeliveryFee">
                                ...
                                <?php default: echo ($info["freight"]); endswitch;?></span></td>
                        <td width="12%" class="tdtitle"></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbdetail">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="22%">
                                    <span attr="address_display" id="labConsignee"><?php echo ($info["name"]); ?></span>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblist">
                        ...
                        <?php if(is_array($order_detail)): $i = 0; $__LIST__ = $order_detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                                <td><img width="68" alt="nopic" src="<?php echo showImage($vo['img']);?>"></td>
                                <td class="ltd">
                                ...
                                <td class="red rtd">¥<?php echo $vo['price']*$vo['goods_number']; ?></td>
            ...
            <div class="mt10" style="text-align:center;">
                ...
                <a href="<?php echo U('Order/index');?>">  <input type="button"  value=" 返回列表 " class="btn btn_cannel"></a></div>
        </div>
    </div>
...
<script src="/shop/Public/js/jquery/plugins/colorpicker.js"></script>
