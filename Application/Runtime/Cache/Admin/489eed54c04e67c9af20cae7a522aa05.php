...
<script type="text/javascript" src="/shop/Public/weixin/js/dingcan/addfollows.js"></script>
<script>
	$(function(){
		$('#menu2_autoreply').show();
		$('.arrow_img_autoreply').attr('src', '/shop/Public/weixin/images/dingcan/index_20.png');
