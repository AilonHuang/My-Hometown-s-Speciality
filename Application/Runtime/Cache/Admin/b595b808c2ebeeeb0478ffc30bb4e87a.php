...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" type="text/css" href="/shop/Public/css/admin/style.css" />
    <title>后台管理</title>
    <script>
	var URL = '/shop/index.php/Admin/Index';
	var SELF = '/shop/index.php/Admin/Index/index.html';
	var ROOT_PATH = '/shop';
...
<body scroll="no">
<div id="header">
	<div class="logo"><a href="<?php echo U('Admin/Index/index');?>" title="后台管理"></a></div>
    <div class="fr">
...
<script src="/shop/Public/Admin/js/index.js"></script>
</body>
</html>