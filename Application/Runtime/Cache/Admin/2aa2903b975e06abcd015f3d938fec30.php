...
<div class="main_right">
    <a href="#" class="addreply"><img src="/shop/Public/weixin/images/dingcan/keywords_03.jpg" /></a>
    ...
    <?php if(is_array($keyinfo)): $i = 0; $__LIST__ = $keyinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="list" style="position:relative">
            <h3>规则：<?php echo ($item["name"]); ?>
                <a href="#" id="zsc_btninfo<?php echo ($item["id"]); ?>" class="add" onclick="zsc_show('<?php echo ($item["id"]); ?>')"></a>
                <a href="#" class="del" id="zsc_del_<?php echo ($item["id"]); ?>" onclick="zscdel('<?php echo ($item["id"]); ?>')"></a>
            </h3>
            <div id="zsc_content_<?php echo ($item["id"]); ?>">
                <p>关键字：<?php echo ($item["keyword"]); ?></p>
...
<script type="text/javascript" src="/shop/Public/weixin/js/dingcan/addkeyword2.js"></script>