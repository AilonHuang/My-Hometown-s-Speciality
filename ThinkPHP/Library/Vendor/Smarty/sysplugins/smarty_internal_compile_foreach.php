...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_CompileBase {
     ...
     */
    public $required_attributes = array('from', 'Goods');
    /**
     * Attribute definition: Overwrites base class.
     *
     * @var array
     ...
     * @see Smarty_Internal_CompileBase
     */
    public $shorttag_order = array('from','Goods','key','name');
    ...
    public function compile($args, $compiler, $parameter)
    {
        ...
        if (!strncmp("\$_smarty_tpl->tpl_vars[$item]", $from, strlen($item) + 24)) {
            $compiler->trigger_template_error("Goods variable {$item} may not be the same variable as at 'from'", $compiler->lex->taglineno);
        }
